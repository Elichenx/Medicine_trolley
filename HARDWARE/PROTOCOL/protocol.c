  ...
  while(1)
  {
    ...
    switch (cmd_type)
    {
      ...
      case SET_P_I_D_CMD:
      {
        ...
        {
          set_p_i_d(&pidMotor1Speed, p_temp, i_temp, d_temp);    // 设置 P I D
        }
        else if (packet.ch == CURVES_CH2)
        {
          set_p_i_d(&pidpos1, p_temp, i_temp, d_temp);    // 设置 P I D
        }
      }
      break;
...
//        if (packet.ch == CURVES_CH1)    
//        {
////          Pid_target(&pidMotor1Speed, set_point);    // 设置目标值
////			 Pid_target(&pidpos1, set_point); 
//				
//				
//        }
